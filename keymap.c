...
// Define keycodes for SOCD Cleaner on/off/toggle.
...
// Use SOCDON, SOCDOFF, SOCDTOG in your layout...

socd_cleaner_t socd_v = {{SOCD_A, SOCD_B}, SOCD_CLEANER_LAST};
socd_cleaner_t socd_v = {{SOCD_C, SOCD_D}, SOCD_CLEANER_LAST};
